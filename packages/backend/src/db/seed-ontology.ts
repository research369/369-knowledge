...
const ALLOWED_RELATIONS = [
  ...
  { from: "stack", rel: "stack_component_of", to: "compound" },
  { from: "stack", rel: "stack_component_of", to: "peptide" },
  ...
  { from: "coach_note", rel: "decision_rule", to: "peptide" },
  { from: "coach_note", rel: "recommended_for", to: "stack" },
  { from: "coach_note", rel: "monitor_with", to: "biomarker" },
  { from: "coach_note", rel: "contraindicated_for", to: "persona" },
