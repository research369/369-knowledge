...
const payloadText = process.env.PEPGPT_MAINTENANCE_KNOWLEDGE || [process.env.PEPGPT_MAINTENANCE_KNOWLEDGE_1, process.env.PEPGPT_MAINTENANCE_KNOWLEDGE_2, process.env.PEPGPT_MAINTENANCE_KNOWLEDGE_3, process.env.PEPGPT_MAINTENANCE_KNOWLEDGE_4, process.env.PEPGPT_MAINTENANCE_KNOWLEDGE_5, process.env.PEPGPT_MAINTENANCE_KNOWLEDGE_6].filter(Boolean).join("");
