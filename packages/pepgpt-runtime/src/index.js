...
function buildInstructions(behavior, knowledge, memory = { profile: {}, turnCount: 0, isNew: false }, liveCatalog = { available: false, products: [] }) {
  return [
    ...
    "For a clear sales intent, do not open with a self-introduction, generic welcome, intake or discovery question. Start with the concrete recommendation. Do not ask for goal, height, weight, name, training or other profile details before giving that first recommendation.",
